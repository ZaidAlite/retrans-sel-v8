...
public class CreateNotesPage extends BasePage {
	...
	private String uploadButtonXpath = "//button[@class='ui-button ui-widget ui-state-default ui-corner-all ui-button-text-icon-left ui-fileupload-upload ui-state-focus ui-state-hover']//span[@class='ui-button-text ui-c'][normalize-space()='Upload']";
